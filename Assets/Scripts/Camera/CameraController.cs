...
public class CameraController : MonoBehaviour
{
    ...
    [Range(.01f, 1f)][SerializeField] private float _detectionRadius = 0.1f;
    [SerializeField] private float _hitOffset = 0.25f;

    [Header("<color=#6A89A7>Settings</color>")]
    [Range(1f, 1000f)][SerializeField] private float _mouseSensitivity = 500.0f;
    [Range(.125f, 1f)][SerializeField] private float _minDistance = 0.25f;
    [Range(1f, 10f)][SerializeField] private float _maxDistance = 5.0f;
    [Range(-90f, 0f)][SerializeField] private float _minRotation = -80.0f;
    [Range(0f, 90f)][SerializeField] private float _maxRotation = 45.0f;
